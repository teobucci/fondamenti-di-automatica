...
\begin{equation*}
\mathrm{det} A=\prod ^n_{i=1} \lambda _i
\end{equation*}
\end{ricalg}
Quindi:
\begin{itemize}
...
\begin{equation}
\boxed{\begin{aligned}
{\displaystyle x(t)} & {\displaystyle =e^{At} x( 0) +\int\limits ^t_0 e^{A( t-\tau )} bu( \tau ) d\tau }\\
...
\Delta _A\left( \lambda \right) =\mathrm{det}\left( \lambda I-A\right) & =\lambda ^n +\alpha _1 \lambda ^{n-1} +\cdots +\alpha _n\\
 ...
 & =\prod\nolimits ^n_{i=1}\left( \lambda -\lambda _i\right)\\
 & =\prod\nolimits ^k_{i=1}\left( \lambda -\lambda _i\right)^{a_i}
\end{aligned}
\end{equation*}
...
\begin{equation*}
\mathrm{tr} A=\sum\limits ^n_{i=1} a_{ii} =\sum\limits ^n_{i=1} \lambda _i
\end{equation*}
\end{ricalg}
...
h(t) =\int\limits ^t_0 f( \tau ) d\tau \ \ \xrightarrow{\mathcal{L}} \ \ H( s) =\frac{1}{s} F( s)
\end{equation*}
...
f(t) *h(t) =\int\limits ^t_0 f( t-\tau ) h( \tau ) d\tau \ \ \xrightarrow{\mathcal{L}} \ \ F( s) H( s)
\end{equation*}
\end{itemize}
