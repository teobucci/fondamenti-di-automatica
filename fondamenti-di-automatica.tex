...
\begin{equation*}
\mathrm{det} A=\prod ^{n}_{i=1} \lambda _{i}
\end{equation*}
\end{ricalg}
Quindi:
\begin{itemize}
\item tempo continuo: $\mathrm{det} A=0\Leftrightarrow \exists \lambda _{i} =0$ (se ne esiste almeno uno nullo)
\item tempo discreto: $\mathrm{det}( I-A) =0\Leftrightarrow \exists \lambda _{i} =1$ (se ne esiste almeno uno unitario)
\end{itemize}
...
\begin{equation}
\boxed{\begin{aligned}
{\displaystyle x( t)} & {\displaystyle =e^{At} x( 0) +\int\limits ^{t}_{0} e^{A( t-\tau )} bu( \tau ) d\tau }\\
...
\begin{equation*}
(sI-A)^{-1} =\frac{P( s)}{\Delta _{A}( s)}
\end{equation*}
Sostituiamola in $y$
\begin{equation*}
y=\left[ c\frac{P( s)}{\Delta _{A}( s)} b+d\right] u=\left[\frac{cP( s) b+d\Delta _{A}( s)}{\Delta _{A}( s)}\right] u=G( s) u
\end{equation*}
Il grado di $cP( s) b$ è $< n$, mentre il grado di $d\Delta _{A}( s)$ è $n$. Di conseguenza il grado del numeratore complessivo è $n$ se $d\neq 0$ (sistema improprio), mentre è strettamente minore di $n$ se $d=0$. Scriviamo quindi la funzione di trasferimento come rapporto di polinomi.
\begin{equation*}
G( s) =\frac{N( s)}{D( s)} =\frac{N( s)}{\Delta _{A}( s)} =\frac{\beta _{0} s^{n} +\beta _{1} s^{n-1} +\cdots +\beta _{n}}{s^{n} +\alpha _{1} s^{n-1} +\cdots +\alpha _{n}}
\end{equation*}
Il denominatore ha sempre grado $n$, mentre il numeratore ha grado $\leqslant n$. Indichiamo con $\beta _{m}$ il primo coefficiente non nullo.
\begin{equation*}
G( s) =\frac{\beta _{m} s^{n-m} +\cdots +\beta _{n}}{s^{n} +\alpha _{1} s^{n-1} +\cdots +\alpha _{n}}
\end{equation*}
e fattorizziamo questi polinomi
\begin{equation}
G( s) =\frac{\beta _{m}( s-q_{1})( s-q_{2}) \cdots ( s-q_{n-m})}{( s-p_{1})( s-p_{2}) \cdots ( s-p_{n})}\begin{array}{ l }
\rightarrow \ \text{zeri}\\
\rightarrow \ \text{poli}
\end{array}
\end{equation}
I $p_{i}$ sono le radici del denominatore e sono dette \textbf{poli}, i $q_{i}$ sono le radici del numeratore e sono detti \textbf{zeri}. Se dovessero esserci poli e zeri uguali, ci sarebbe una terrificante semplificazione e perdita di grado.
...
0 & 1 &  &  & \\
 ...
 &  & \ddots  & \ddots  & \\
 &  &  & 0 & 1\\
-\alpha _{n} & \cdots  & \cdots  & -\alpha _{2} & -\alpha _{1}
...
\end{bmatrix}\\
c & =\begin{bmatrix}
\beta _{n} & \cdots  & \cdots  & \beta _{2} & \beta _{1}
...
\begin{equation*}
\dot{x} =ax+bu\ \ \Rightarrow \ \ x_{L}\left( t\right) =\phi \left( t\right) x\left( 0\right) =e^{at} x\left( 0\right)
\end{equation*}
\begin{itemize}
...
\boxed{T_{R} \simeq 5T=-\frac{5}{a}}
\end{equation*}
\item se $a=0$ è sempl. stabile, $x_{L}\left( t\right) =e^{at} x\left( 0\right) =x\left( 0\right)$
...
\boxed{T=-\frac{1}{\log\left| a\right| }} \ \ \Rightarrow \ \ \boxed{T_{R} \simeq 5T=-\frac{5}{\log\left| a\right| }}
\end{equation*}
...
\vdots \\
z_{n}
\end{bmatrix} \in \mathbb{R}^{n} \ \ \ \ z=Tx,\ x=T^{-1} z,\ \mathrm{det} T\neq 0
\end{equation*}
...
\dot{z}_{1} =\lambda _{1} z_{1}\\
\vdots \\
\dot{z}_{n} =\lambda _{n} z_{n}
\end{array}
\end{equation*}
sono $n$ sistemi di ordine $1$ che evolvono in maniera indipendente come $z_{i}\left( t\right) =e^{\lambda _{i} t} z_{i}\left( 0\right)$. Allora, se $A$ è diagonalizzabile,
\begin{enumerate}
\item $A$ è asint. stabile $\Leftrightarrow $ $\mathrm{Re}\left( \lambda _{i}\right) < 0\ \forall i$
\item $A$ è sempl. stabile $\Leftrightarrow $ $\mathrm{Re}\left( \lambda _{i}\right) \leqslant 0\ \forall i,\ \exists i:\mathrm{Re}\left( \lambda _{i}\right) =0$
\item $A$ è instabile $\Leftarrow $ $\exists i:\mathrm{Re}\left( \lambda _{i}\right)  >0$
\end{enumerate}

Gli autovalori sono le radici del polinomio caratteristico
\begin{equation*}
\Delta _{A}\left( \lambda \right) =\Delta _{\tilde{A}}\left( \lambda \right) =\mathrm{det}\left( \lambda I-A\right) =\lambda ^{n} +\alpha _{1} \lambda ^{n-1} +\cdots +\alpha _{n}
\end{equation*}
Ci può essere un certo $\lambda _{i} =a+ib$, ma dato che stiamo lavorando con matrici a valori reali in quel caso c'è anche il suo complesso coniugato $\lambda _{j} =a-ib$ (anche le corrispondenti $z$ sarebbero complesse). Per capire cosa succede, ricordiamo la formula di Eulero
\begin{equation*}
\begin{aligned}
z_{i}\left( t\right) & =e^{\left( a+ib\right) t} z_{i}\left( 0\right) =e^{at} e^{ibt} z_{i}\left( 0\right)\\
 & =e^{at}\left[\cos\left( bt\right) +i\sin\left( bt\right)\right] z_{i}\left( 0\right)
\end{aligned}
\end{equation*}
La convergenza è descritta dalla parte reale di $\lambda _{i}$. Studiamo la coppia coniugata $\lambda _{1,2} =a\pm ib$:
\begin{equation*}
\gamma _{1} e^{\lambda _{1} t} +\gamma _{2} e^{\lambda _{2} t} =\gamma _{1} e^{at} e^{ibt} +\gamma _{2} e^{at} e^{-ibt} =\dotsc =\alpha e^{at}\left(\sin\left( bt\right) +\beta \right)
\end{equation*}
...
\begin{equation*}
\boxed{T_{D} =\max_{i} T_{i}} \ \ \ \ \boxed{T_{R} \simeq 5T_{D}}
\end{equation*}
...
\begin{equation*}
\boxed{T_{1,2} =-\frac{1}{\mathrm{Re}\left( \lambda _{1,2}\right)}}
\end{equation*}
\begin{ricalg}
...
\begin{aligned}
\Delta _{A}\left( \lambda \right) =\mathrm{det}\left( \lambda I-A\right) & =\lambda ^{n} +\alpha _{1} \lambda ^{n-1} +\cdots +\alpha _{n}\\
 & =\left( \lambda -\lambda _{1}\right) \cdots \left( \lambda -\lambda _{n}\right)\\
 & =\prod\nolimits ^{n}_{i=1}\left( \lambda -\lambda _{i}\right)\\
 & =\prod\nolimits ^{k}_{i=1}\left( \lambda -\lambda _{i}\right)^{a_{i}}
\end{aligned}
\end{equation*}

con $k$ il numero di autovalori distinti e $a_{i}$ la loro molteplicità algebrica.
\end{ricalg}
\begin{ricalg}
...
Dire che l'autovalore $\lambda _{i}$ è \textbf{regolare} significa dire che la molteplicità algebrica è uguale alla molteplicità geometrica, ovvero che ogni mini-blocco deve essere unitario
\begin{equation*}
\boxed{\lambda _{i} \ \text{regolare} \ \ \Leftrightarrow \ \ n_{i} =a_{i} \ \ \Leftrightarrow \ \ b_{i} =1}
\end{equation*}
Guardiamo ora il singolo mini-blocco
\begin{equation*}
J^{l}_{i} =\begin{bmatrix}
\lambda _{i} & 1 &  & \\
 & \lambda _{i} & \ddots  & \\
 &  & \ddots  & 1\\
 &  &  & \lambda _{i}
\end{bmatrix}
\end{equation*}
A cosa ci è servito questo? Se la matrice è diagonalizzabile riusciamo a decomporre $z$ in $n$ sottosistemi tra loro indipendenti, se non lo è posso fare questa decomposizione in sistemi che tra loro non interagiscono, quindi si tratta di capire come funziona il singolo $J^{l}_{i}$: la sua micro-equazione di stato è fatta così
\begin{equation*}
\dot{z}^{l}_{i} =J^{l}_{i} z^{l}_{i}
\end{equation*}
applicando la formula di Lagrange a questo diventa
\begin{equation*}
z^{l}_{i}\left( t\right) =e^{J^{l}_{i} t} z^{l}_{i}\left( 0\right)
\end{equation*}
Si tratta ora di capire com'è fatta $e^{J^{l}_{i} t}$, si può dimostrare che è fatta così
\begin{equation*}
e^{J^{l}_{i} t} =\begin{bmatrix}
1 & t & t^{2} /2 & \dotsc  & \\
 & 1 & t & \ddots  & \vdots \\
 &  & 1 & \ddots  & t^{2} /2\\
 &  &  & \ddots  & t\\
 &  &  &  & 1
\end{bmatrix} e^{\lambda _{i} t}
\end{equation*}
Contiene esponenziali ed esponenziali moltiplicati per potenze di $t$, quello che fanno dipende dalla parte reale di $\lambda _{i}$. Si noti che se $\lambda _{i} =0$, si ha solo la matrice, e ciò che fa \textit{dipende dalla dimensione della matrice}! Se avesse dimensione $1$ sarebbe formata solo da
\begin{equation*}
\begin{bmatrix}
1
\end{bmatrix}
\end{equation*}
che non diverge. Dalla dimensione $2$ in poi si includono i $t$ e diverge. La dimensione della matrice dipende dalla regolarità dell'autovalore, che a sua volta dipende da $b_{i}$. La dimensione della matrice è $1$ se $b_{i} =1$.
...
Sia $\dot{x} =Ax$, allora
\begin{itemize}
\item $\mathrm{Re}\left( \lambda _{i}\right) < 0\ \forall i\Leftrightarrow A$ asint. stabile
\item $\exists i:\mathrm{Re}\left( \lambda _{i}\right)  >0\Rightarrow A$ instabile (instabilità forte)
\item $\mathrm{Re}\left( \lambda _{i}\right) \leqslant 0\ \forall i,\exists i:\mathrm{Re}\left( \lambda _{i}\right) =0$
\begin{itemize}
\item $b_{i} =1$ (ossia $a_{i} =n_{i}$) $\forall i:\mathrm{Re}\left( \lambda _{i}\right) =0\Leftrightarrow A$ sempl. stabile
\item $b_{i}  >1$ per almeno un $i$, cioè l'autovalore è irregolare e tale che $\mathrm{Re}\left( \lambda _{i}\right) =0\Rightarrow A$ instabile (instabilità debole)
\end{itemize}
\end{itemize}

Sono presenti oscillazioni se $\exists \lambda _{i}$ complessi coniugati.
}
...
%Straight Lines [id:da3628194012016872] 
...
%Straight Lines [id:da9170830484943664] 
...
%Straight Lines [id:da09079601409955562] 
...
%Straight Lines [id:da9693667016738643] 
...
%Straight Lines [id:da3746878097480455] 
...
%Straight Lines [id:da11632870668225892] 
\draw    (91.5,37) -- (117,37) ;
...
%Straight Lines [id:da5461954305435337] 
\draw    (91.5,76) -- (117,76) ;
...
%Straight Lines [id:da7836327407393724] 
\draw    (91.5,37) -- (91.5,76) ;
%Straight Lines [id:da1806123586496835] 
\draw    (63,55) -- (91.5,55) ;

% Text Node
\draw (65,31.4) node [anchor=north west][inner sep=0.75pt]    {$u$};
% Text Node
\draw (195,23.4) node [anchor=north west][inner sep=0.75pt]    {$x_{1}$};
% Text Node
\draw (195,63.4) node [anchor=north west][inner sep=0.75pt]    {$x_{2}$};
% Text Node
\draw (301,35.4) node [anchor=north west][inner sep=0.75pt]    {$u$};
% Text Node
\draw (376,31.4) node [anchor=north west][inner sep=0.75pt]    {$x_{2}$};
% Text Node
\draw (458,32.4) node [anchor=north west][inner sep=0.75pt]    {$x_{1}$};
...
\begin{itemize}
\item $\left| \lambda _{i}\right| < 1\ \forall i\Leftrightarrow A$ asint. stabile
\item $\exists i:\left| \lambda _{i}\right|  >1\Rightarrow A$ instabile (instabilità forte)
\item $\left| \lambda _{i}\right| \leqslant 1\ \forall i,\exists i:\left| \lambda _{i}\right| =1$
\begin{itemize}
\item se $b_{i} =1\ \left( a_{i} =n_{i}\right) \ \forall i\ \left| \lambda _{i}\right| =1$, cioè quelli critici sono regolari, $\Rightarrow A$ sempl. stabile
\item se $b_{i}  >1\ \left( a_{i} \neq n_{i}\right)$ per almeno un $i:\left| \lambda _{i}\right| =1\Rightarrow A$ instabile (debolmente)
\end{itemize}
\end{itemize}

Sono presenti oscillazioni se si verifica almeno una delle due condizioni
\begin{itemize}
\item $\exists \lambda _{i} \in \mathbb{R} ,\lambda _{i} < 0$
\item $\exists \lambda _{i}$ complessi coniugati
\end{itemize}
}
...
\begin{equation*}
\Delta _{A}\left( \lambda \right) =\lambda ^{n} +\alpha _{1} \lambda ^{n-1} +\cdots +\alpha 
\end{equation*}
si può dire che
\begin{equation*}
\boxed{\text{se} \ A\ \text{è asint. stabile} \ \Rightarrow \alpha _{i}  >0\ \forall i}
\end{equation*}
La coimplicazione vale solo per $n=2$. La dimostrazione è la seguente:
\begin{equation*}
\begin{aligned}
\Delta _{A}\left( \lambda \right) & =\left( \lambda -\lambda _{1}\right) \cdots \left( \lambda -\lambda _{n}\right)\\
 & =\lambda ^{n} +\lambda ^{n-1}\left( \lambda _{1} \lambda _{2} +\lambda _{1} \lambda _{3} +\dotsc \right) +\lambda ^{n-2}\left( \lambda _{1} \lambda _{2} \lambda _{3} +\dotsc \right) +\cdots +\left( -1\right)^{n} \lambda _{1} \lambda _{2} \dotsc \lambda _{n}
\end{aligned}
\end{equation*}
Se tutti i $\lambda $ sono negativi ($A$ asint. stabile) il loro prodotto è positivo se sono in numero pari, negativo se sono dispari, ma in tal caso c'è $-1$. I prodotti a coppie, i prodotti a terne, e tutti gli altri, danno luogo a coefficienti positivi. Non vale il contrario in generale, ma solo per $n=2$. \textit{È un test rapido per escludere l'asint. stabilità.} Ad esempio, se almeno un coefficiente di $\Delta _{A}\left( \lambda \right)$ fosse nullo o negativo, possiamo escludere l'asint. stabilità subito.
\section{Test di Hurwitz (sistemi a tempo continuo)}

Consideriamo $\dot{x} =Ax$ e il polinomio caratteristico
\begin{equation*}
\Delta _{A}\left( \lambda \right) =\lambda ^{n} +\alpha _{1} \lambda ^{n-1} +\cdots +\alpha _{n}
\end{equation*}
Costruiamo la matrice $H\in \mathbb{R}^{n\times n}$, ciascuna riga comincia con i coefficienti dispari, e prosegue in ordine descrescente coi rimanenti, poi un $1$ e infine $0$ fino in fondo. Riempiamo righe fino alla fine. Se arriviamo a riempire tutti gli $\alpha _{i}$ si pongono $\alpha _{i} =0,\forall i >n$.
\begin{equation*}
H=\begin{bmatrix}
\alpha _{1} & 1 & 0 & 0 & 0 & \dotsc  & \\
\alpha _{3} & \alpha _{2} & \alpha _{1} & 1 & 0 & \dotsc  & \\
\alpha _{5} & \alpha _{4} & \alpha _{3} & \alpha _{2} & \alpha _{1} & 1 & 0\\
\vdots  &  &  &  &  &  & \\
 &  &  &  &  &  & \\
 &  &  &  &  &  & \\
 &  &  &  &  &  & 
...
\end{equation*}
Se consideriamo le sottomatrici appoggiate all'angolo Nord-Ovest, di dimensione crescente $D_{1} ,D_{2} ,\dotsc ,D_{n} =H$ il criterio di Hurwitz afferma che
\begin{equation*}
\boxed{A\ \text{asint. stabile} \ \ \Leftrightarrow \ \ \mathrm{det} D_{i}  >0\ \forall i=1,\dotsc ,n}
\end{equation*}
Non sappiamo nulla su dinamiche oscillatorie, tempi di risposta ecc. Vediamo anche nello specifico due casi:
\begin{itemize}
\item $n=2$, il polinomio caratteristico è $\Delta _{A}\left( \lambda \right) =\lambda ^{2} +\alpha _{1} \lambda +\alpha _{2}$, la matrice $H$ è quindi\begin{equation*}
H=\begin{bmatrix}
\alpha _{1} & 1\\
0 & \alpha _{2}
\end{bmatrix}
...
A\ \text{asint. stabile} \ \ \Leftrightarrow \ \ \alpha _{1}  >0,\alpha _{2}  >0
\end{equation*}
\item $n=3$, il polinomio caratteristico è $\Delta _{A}\left( \lambda \right) =\lambda ^{3} +\alpha _{1} \lambda ^{2} +\alpha _{2} \lambda +\alpha _{3}$, la matrice $H$ è quindi\begin{equation*}
H=\begin{bmatrix}
\alpha _{1} & 1 & 0\\
\alpha _{3} & \alpha _{2} & 1\\
0 & 0 & \alpha _{3}
\end{bmatrix}
\end{equation*}
...
\begin{cases}
\alpha _{1}  >0\\
\alpha _{2} \alpha _{1}  >\alpha _{3} \ \left(\text{cioè} \ \mathrm{det} D_{2}  >0\right)\\
\alpha _{3}\left(\mathrm{det} D_{2}\right)  >0
\end{cases} \ \ \Leftrightarrow \ \ \begin{cases}
\alpha _{i}  >0,\forall i\\
\alpha _{2} \alpha _{1}  >\alpha _{3}
\end{cases}
\end{equation*}
\end{itemize}
...
%Straight Lines [id:da9266038540633819] 
\draw    (100,40) -- (147,40) ;
...
%Straight Lines [id:da6757459652106612] 
\draw    (200,40) -- (247,40) ;
...
%Straight Lines [id:da7090982742778738] 
\draw    (350,40) -- (397,40) ;
...
%Straight Lines [id:da7236873565259767] 
\draw    (450,40) -- (497,40) ;
...
% Text Node
\draw (101,12.4) node [anchor=north west][inner sep=0.75pt]    {$u_{1}$};
% Text Node
\draw (217,12.4) node [anchor=north west][inner sep=0.75pt]    {$y_{1}$};
% Text Node
\draw (74,72.4) node [anchor=north west][inner sep=0.75pt]    {$( A_{1} ,b_{1} ,c_{1}) ,x_{1} \in \mathbb{R}^{n_{1}} ,G_{1}( s)$};
% Text Node
\draw (351,12.4) node [anchor=north west][inner sep=0.75pt]    {$u_{2}$};
% Text Node
\draw (467,12.4) node [anchor=north west][inner sep=0.75pt]    {$y_{2}$};
% Text Node
\draw (324,72.4) node [anchor=north west][inner sep=0.75pt]    {$( A_{2} ,b_{2} ,c_{2}) ,x_{2} \in \mathbb{R}^{n_{2}} ,G_{2}( s)$};
...
\begin{equation*}
y=G_{2} u_{2} =G_{2} y_{1} =G_{2} G_{1} u_{1} \Rightarrow \boxed{G\left( s\right) =G_{1}\left( s\right) G_{2}\left( s\right)}
\end{equation*}
\section{Parallelo}

In questo caso $u_{1} =u_{2} =u$. Si verifica
\begin{equation*}
\tilde{A} =\begin{bmatrix}
A_{1} & 0\\
0 & A_{2}
...
\begin{equation*}
y=y_{1} +y_{2} =G_{1} u_{1} +G_{2} u_{2} =\left( G_{1} +G_{2}\right) u\Rightarrow \boxed{G\left( s\right) =G_{1}\left( s\right) +G_{2}\left( s\right)}
\end{equation*}
\section{Retroazione}
...
%Straight Lines [id:da9600248903675683] 
\draw    (230,40) -- (277,40) ;
...
%Straight Lines [id:da3557868187468849] 
\draw    (330,40) -- (427,40) ;
...
%Straight Lines [id:da09071943900666102] 
\draw    (220,100) -- (220,53) ;
...
%Straight Lines [id:da24790593035991249] 
...
%Straight Lines [id:da7084510286527559] 
\draw    (160,40) -- (207,40) ;
...
%Straight Lines [id:da04585150910472291] 
\draw    (220,100) -- (280,100) ;
%Straight Lines [id:da31149515237135694] 
\draw    (380,40) -- (380,100) ;

% Text Node
\draw (250,12.4) node [anchor=north west][inner sep=0.75pt]    {$u_{1}$};
% Text Node
\draw (347,12.4) node [anchor=north west][inner sep=0.75pt]    {$y_{1} =y$};
% Text Node
\draw (251,72.4) node [anchor=north west][inner sep=0.75pt]    {$y_{2}$};
% Text Node
\draw (347,72.4) node [anchor=north west][inner sep=0.75pt]    {$u_{2}$};
% Text Node
...
% Text Node
\draw (284,30.4) node [anchor=north west][inner sep=0.75pt]    {$G_{1}( s)$};
% Text Node
\draw (284,90.4) node [anchor=north west][inner sep=0.75pt]    {$G_{2}( s)$};


\end{tikzpicture}
\end{figure}\FloatBarrier

In questo caso $y=y_{1} =u_{2}$ e $u_{1} =u\pm y_{2}$. Quindi
\begin{equation*}
\begin{aligned}
\dot{x} =\begin{bmatrix}
\dot{x}_{1}\\
...
\end{bmatrix}\\
 & =\begin{bmatrix}
\ \ \ A_{1} x_{1} +b_{1}( u\pm y_{2})\\
A_{2} x_{2} +b_{2} y_{1}
\end{bmatrix}\\
 & =\begin{bmatrix}
\ \ \ A_{1} x_{1} +b_{1} u\pm b_{1} c_{2} x_{2}\\
A_{2} x_{2} +b_{2} c_{1} x_{1}
\end{bmatrix}\\
 & =\underbrace{\begin{bmatrix}
A_{1} & \pm b_{1} c_{2}\\
...
mentre l'uscita
\begin{equation*}
y=y_{1} =c_{1} x_{1} =\underbrace{\begin{bmatrix}
c_{1} & 0
\end{bmatrix}}_{\tilde{c}}\begin{bmatrix}
x_{1}\\
x_{2}
\end{bmatrix}
\end{equation*}
La matrice $\tilde{A}$ non ha strutture particolari. \textbf{Le matrici }$A_{1} ,A_{2}$\textbf{ non dicono nulla a priori sulla stabilità dell'aggregato.} Bisogna studiare caso per caso.
...
%Straight Lines [id:da6748394873745365] 
...
%Straight Lines [id:da49631974081004215] 
...
% Text Node
\draw (270,72.4) node [anchor=north west][inner sep=0.75pt]    {$\lambda _{1}$};
% Text Node
\draw (231,12.4) node [anchor=north west][inner sep=0.75pt]    {$\lambda _{2}$};
% Text Node
\draw (476,112.4) node [anchor=north west][inner sep=0.75pt]    {$\mathrm{Re}$};
% Text Node
\draw (410,68.4) node [anchor=north west][inner sep=0.75pt]    {$\mathrm{Im}$};
% Text Node
\draw (393,130.4) node [anchor=north west][inner sep=0.75pt]    {$\lambda _{1}$};
% Text Node
\draw (371,130.4) node [anchor=north west][inner sep=0.75pt]    {$\lambda _{2}$};
...
\draw  (20,119.67) -- (280,119.67)(150.5,30) -- (150.5,210) (273,114.67) -- (280,119.67) -- (273,124.67) (145.5,37) -- (150.5,30) -- (155.5,37)  ;
%Straight Lines [id:da7797632634451299] 
...
%Straight Lines [id:da05936517405648356] 
\draw [line width=1.5]    (241.02,86.47) -- (58.98,153.53) ;
...
\draw (410,68.4) node [anchor=north west][inner sep=0.75pt]    {$\mathrm{Im}$};
% Text Node
\draw (443,130.4) node [anchor=north west][inner sep=0.75pt]    {$\lambda _{1}$};
% Text Node
\draw (371,130.4) node [anchor=north west][inner sep=0.75pt]    {$\lambda _{2}$};
...
\draw  (20,119.67) -- (280,119.67)(150.5,30) -- (150.5,210) (273,114.67) -- (280,119.67) -- (273,124.67) (145.5,37) -- (150.5,30) -- (155.5,37)  ;
%Straight Lines [id:da9303456469287767] 
...
%Straight Lines [id:da47505319577160265] 
...
% Text Node
\draw (269,80.4) node [anchor=north west][inner sep=0.75pt]    {$\lambda _{1}$};
% Text Node
\draw (216,13.4) node [anchor=north west][inner sep=0.75pt]    {$\lambda _{2}$};
% Text Node
\draw (476,112.4) node [anchor=north west][inner sep=0.75pt]    {$\mathrm{Re}$};
% Text Node
\draw (410,68.4) node [anchor=north west][inner sep=0.75pt]    {$\mathrm{Im}$};
...
\draw (443,130.4) node [anchor=north west][inner sep=0.75pt]    {$\lambda _{1}$};
% Text Node
\draw (421,130.4) node [anchor=north west][inner sep=0.75pt]    {$\lambda _{2}$};
...
\draw  (20,119.67) -- (280,119.67)(150.5,30) -- (150.5,210) (273,114.67) -- (280,119.67) -- (273,124.67) (145.5,37) -- (150.5,30) -- (155.5,37)  ;
%Straight Lines [id:da5930204137096313] 
\draw [line width=1.5]    (208.37,32.52) -- (101.63,197.48) ;
...
%Straight Lines [id:da27569766917001104] 
\draw [line width=1.5]    (260,90) -- (40,150) ;
...
%Straight Lines [id:da062026932818612934] 
...
%Straight Lines [id:da3859393761988763] 
...
%Straight Lines [id:da9843920537963222] 
...
%Straight Lines [id:da23534535346703267] 
...
%Straight Lines [id:da896689813946159] 
...
\draw (269,80.4) node [anchor=north west][inner sep=0.75pt]    {$\lambda _{1}$};
% Text Node
\draw (224,13.4) node [anchor=north west][inner sep=0.75pt]    {$\lambda _{2}$};
% Text Node
\draw (476,112.4) node [anchor=north west][inner sep=0.75pt]    {$\mathrm{Re}$};
% Text Node
\draw (410,68.4) node [anchor=north west][inner sep=0.75pt]    {$\mathrm{Im}$};
% Text Node
\draw (422,130.4) node [anchor=north west][inner sep=0.75pt]    {$\lambda _{1}$};
% Text Node
\draw (381,130.4) node [anchor=north west][inner sep=0.75pt]    {$\lambda _{2}$};
...
\tilde{A}_{1} =\begin{bmatrix}
\lambda  & 0\\
0 & \lambda 
\end{bmatrix} \ \ \ \ \tilde{A}_{2} =\begin{bmatrix}
\lambda  & 1\\
0 & \lambda 
\end{bmatrix}
\end{equation*}
...
\draw  (370,119.8) -- (470,119.8)(419.5,90) -- (419.5,150) (463,114.8) -- (470,119.8) -- (463,124.8) (414.5,97) -- (419.5,90) -- (424.5,97)  ;
\draw   (386.82,115.61) -- (395.61,124.39)(395.61,115.61) -- (386.82,124.39) ;
%Straight Lines [id:da4808298377771425] 
...
%Straight Lines [id:da22419007964380389] 
...
%Straight Lines [id:da3538965102852132] 
...
%Straight Lines [id:da2018238680156521] 
...
%Straight Lines [id:da4261769075739468] 
...
\draw (410,68.4) node [anchor=north west][inner sep=0.75pt]    {$\mathrm{Im}$};
% Text Node
\draw (341,130.4) node [anchor=north west][inner sep=0.75pt]    {$\lambda _{1} =\lambda _{2}$};
...
\draw  (20,119.67) -- (280,119.67)(150.5,30) -- (150.5,210) (273,114.67) -- (280,119.67) -- (273,124.67) (145.5,37) -- (150.5,30) -- (155.5,37)  ;
%Straight Lines [id:da7218094861912767] 
...
% Text Node
\draw (466,112.4) node [anchor=north west][inner sep=0.75pt]    {$\mathrm{Re}$};
% Text Node
\draw (400,68.4) node [anchor=north west][inner sep=0.75pt]    {$\mathrm{Im}$};
% Text Node
\draw (331,130.4) node [anchor=north west][inner sep=0.75pt]    {$\lambda _{1} =\lambda _{2}$};
...
%Straight Lines [id:da026727923503337303] 
...
% Text Node
\draw (486,112.4) node [anchor=north west][inner sep=0.75pt]    {$\mathrm{Re}$};
% Text Node
\draw (420,68.4) node [anchor=north west][inner sep=0.75pt]    {$\mathrm{Im}$};
...
%Straight Lines [id:da3084818100914466] 
...
%Straight Lines [id:da2299591946766324] 
...
% Text Node
\draw (486,122.4) node [anchor=north west][inner sep=0.75pt]    {$\mathrm{Re}$};
% Text Node
\draw (417,55.4) node [anchor=north west][inner sep=0.75pt]    {$\mathrm{Im}$};
...
%Straight Lines [id:da3220708716435725] 
\draw    (170,20) -- (170,130) ;
...
%Straight Lines [id:da573431605500109] 
\draw    (90,30) -- (147,30) ;
...
%Straight Lines [id:da19690244169696558] 
\draw    (220,30) -- (277,30) ;
...
%Straight Lines [id:da6933586443823543] 
\draw    (140,40) -- (197,40) ;
...
%Straight Lines [id:da3216881243057266] 
\draw    (270,40) -- (327,40) ;
...
%Straight Lines [id:da5054748013340113] 
\draw    (60,40) -- (117,40) ;
...
%Straight Lines [id:da49863947550203513] 
\draw    (300,40) -- (300,90) ;
%Straight Lines [id:da9704481650256027] 
\draw    (300,90) -- (263,90) ;
...
%Straight Lines [id:da16003942307135177] 
\draw    (210,90) -- (130,90) ;
%Straight Lines [id:da9400371626534303] 
\draw    (130,90) -- (130,53) ;
...
\end{bmatrix}}_{\tilde{b}} u
\end{equation*}
Dove $A_{R} ,b_{R}$ è un sistema completamente raggiungibile.
\begin{definition}
...
\draw   (150,10) -- (220,10) -- (220,50) -- (150,50) -- cycle ;
%Straight Lines [id:da8874109820518701] 
\draw    (90,30) -- (147,30) ;
\draw [shift={(150,30)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (10.72,-5.15) -- (0,0) -- (10.72,5.15) -- (7.12,0) -- cycle    ;
%Straight Lines [id:da933638154645507] 
\draw    (220,30) -- (277,30) ;
\draw [shift={(280,30)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (10.72,-5.15) -- (0,0) -- (10.72,5.15) -- (7.12,0) -- cycle    ;
%Shape: Rectangle [id:dp6612594452533773] 
\draw   (280,9) -- (350,9) -- (350,49) -- (280,49) -- cycle ;
%Straight Lines [id:da25285180705977606] 
\draw    (350,29) -- (407,29) ;
...
%Straight Lines [id:da06623641109031486] 
\draw    (90,35) -- (167,35) ;
...
%Straight Lines [id:da5092626109823599] 
\draw    (130,85) -- (167,85) ;
...
%Straight Lines [id:da3626121406115179] 
\draw    (130,35) -- (130,85) ;
%Straight Lines [id:da6708103229697253] 
\draw    (230,35) -- (277,35) ;
...
%Straight Lines [id:da03950560937421943] 
\draw    (340,35) -- (387,35) ;
...
%Straight Lines [id:da8828756102948581] 
\draw    (90,41) -- (167,41) ;
...
%Straight Lines [id:da6944815070470745] 
...
%Straight Lines [id:da9138976010593762] 
\draw    (130,41) -- (130,111) ;
%Straight Lines [id:da9425326182777543] 
\draw    (230,41) -- (277,41) ;
...
%Straight Lines [id:da5561247574566821] 
\draw    (340,41) -- (387,41) ;
...
%Straight Lines [id:da175386319171295] 
\draw    (370,41) -- (370,70) ;
%Straight Lines [id:da2184076855556365] 
\draw    (370,70) -- (200,70) ;
%Straight Lines [id:da7645688107388311] 
\draw    (200,70) -- (200,87) ;
...
%Straight Lines [id:da012100787771931909] 
...
%Straight Lines [id:da9847451960841425] 
...
Studiamo il caso di non completa osservabilità, cioè $\mathrm{rank}( O) =o< n$. Definiamo $X_{O}$ \textbf{sottospazio di osservabilità}
\begin{equation*}
X_{O} =X^{\perp }_{NO} \ \ \Rightarrow \ \ \mathrm{dim} X_{O} =\mathrm{rank}( O) =o
\end{equation*}
...
\end{bmatrix}
\end{equation*}
Dove $A_{O} ,c_{O}$ è un sistema completamente osservabile.
\begin{definition}
...
%Straight Lines [id:da07503731301229433] 
\draw    (40,60) -- (87,60) ;
...
%Straight Lines [id:da45203335002444933] 
\draw    (190,60) -- (327,60) ;
...
%Straight Lines [id:da31024205630704227] 
\draw    (140,120) -- (140,83) ;
...
%Straight Lines [id:da13938650670884578] 
...
%Straight Lines [id:da08501504954383643] 
...
%Straight Lines [id:da2269177709991579] 
\draw    (420,60) -- (457,60) ;
...
A & bk\\
-lc & A+bk+lc
\end{bmatrix}}_{A_{\text{reg}}}\begin{bmatrix}
x\\
\hat{x}
\end{bmatrix} +\underbrace{\begin{bmatrix}
b\\
b
\end{bmatrix}}_{b_{\text{reg}}} v
\end{aligned}
\end{equation*}
...
%Straight Lines [id:da7255739517075415] 
\draw    (40,80) -- (90,80) ;
%Straight Lines [id:da8860860330514739] 
...
%Straight Lines [id:da8891273040675431] 
...
%Straight Lines [id:da9046520450906421] 
...
%Straight Lines [id:da38199617846952627] 
...
%Straight Lines [id:da1842538598656498] 
...
%Straight Lines [id:da4867587777911413] 
\draw    (190,210) -- (250,210) ;
%Straight Lines [id:da0396413750953335] 
...
%Straight Lines [id:da24838449829090536] 
...
%Straight Lines [id:da2464006161672272] 
...
%Straight Lines [id:da08814804079254746] 
...
%Straight Lines [id:da3312928047596977] 
...
%Straight Lines [id:da8082011544952894] 
...
% Text Node
\draw (333,152.4) node [anchor=north west][inner sep=0.75pt]    {$c_{b}$};
% Text Node
\draw (203,109.4) node [anchor=north west][inner sep=0.75pt]    {$z_{b}$};
% Text Node
\draw (203,189.4) node [anchor=north west][inner sep=0.75pt]    {$z_{c}$};
% Text Node
\draw (203,269.4) node [anchor=north west][inner sep=0.75pt]    {$z_{d}$};
% Text Node
\draw (203,9.4) node [anchor=north west][inner sep=0.75pt]    {$z_{a}$};
% Text Node
\draw (333,242.4) node [anchor=north west][inner sep=0.75pt]    {$c_{d}$};
% Text Node
...
\begin{equation*}
G( s) =c( sI-A)^{-1} b=c_{b}( sI-A_{b})^{-1} b_{b} =G_{b}( s)
\end{equation*}
...
%Straight Lines [id:da6497589021309071] 
\draw [line width=2.25]    (120,60) -- (180,60) ;
%Straight Lines [id:da5318157832310242] 
...
Si ha $\int ^{+\infty }_{0} u_{\delta }( t) dt=1$. Facciamo tendere $\delta \rightarrow 0$ e troviamo l'impulso. Ha queste proprietà:
\begin{itemize}
\item $\mathrm{imp}( t) =0\ \forall t\neq 0$
\item $\int ^{0^{+}}_{0^{-}}\mathrm{imp}( t) dt=1$
\end{itemize}

Studiamo l'uscita
\begin{equation*}
\begin{aligned}
y( t) =cx( t) & =c\int ^{t}_{0} e^{A( t-\tau )} bu( \tau ) d\tau \\
 & =c\int ^{0^{+}}_{0^{-}} e^{A( t-\tau )} b\mathrm{imp}( \tau ) d\tau \\
 & =ce^{At} b\int ^{0^{+}}_{0^{-}}\mathrm{imp}( \tau ) d\tau \\
...
\begin{aligned}
y( t) =cx( t) & =c\int ^{t}_{0} e^{A( t-\tau )} bu( \tau ) d\tau \\
 & =\int ^{t}_{0}\boxed{ce^{A( t-\tau )} b} u( \tau ) d\tau \\
 & =\int ^{t}_{0}\boxed{g( t-\tau )} u( \tau ) d\tau 
\end{aligned}
\end{equation*}
...
\begin{equation}
F( s) :\mathbb{C}\rightarrow \mathbb{C} \ \ \ \ F( s) =\mathcal{L} a[ f( t)] =\int ^{+\infty }_{0} f( t) e^{-st} dt
\end{equation}
In particolare
\begin{equation*}
...
\begin{itemize}
\item $u( t) =\mathrm{imp}( t)$, allora\begin{equation*}
\begin{aligned}
U( s) & =\int ^{+\infty }_{0}\mathrm{imp}( t) e^{-st} dt\\
 & =\int ^{0^{+}}_{0^{-}}\mathrm{imp}( t) dt=1
\end{aligned}
\end{equation*}
\item $u( t) =\mathrm{sca}( t)$, allora\begin{equation*}
\begin{aligned}
U( s) & =\int ^{+\infty }_{0} 1\cdotp e^{-st} dt\\
 & =-\frac{1}{s}\left[ e^{-st}\right]^{+\infty }_{0} =\frac{1}{s} ,\ \ \text{se} \ \mathrm{Re}( s)  >0
\end{aligned}
\end{equation*}
\item $f( t) =e^{at} ,a\in \mathbb{R}$, allora\begin{equation*}
\begin{aligned}
F( s) & =\int ^{+\infty }_{0} e^{at} e^{-st} dt=\int ^{+\infty }_{0} e^{( a-s) t} dt\\
 & =\frac{1}{a-s}\left[ e^{( a-s) t}\right]^{+\infty }_{0}\\
 & =\frac{1}{s-a} ,\ \ \text{se} \ \mathrm{Re}( s)  >\mathrm{Re}( a)
\end{aligned}
\end{equation*}
\item $f( t) =te^{at}$, allora $F( s) =\frac{1}{( s-a)^{2}}$
\item $f( t) =\frac{1}{2} t^{2} e^{at}$, allora $F( s) =\frac{1}{( s-a)^{3}}$
\item $u( t) =\mathrm{ramp}( t)$, allora $U( s) =\frac{1}{s^{2}}$
\end{itemize}
...
\toprule 
 $u( t)$ & $\mathrm{imp}( t)$ & $\mathrm{sca}( t)$ & $e^{at}$ & $te^{at}$ & $\frac{1}{2!} t^{2} e^{at}$ & $\mathrm{ramp}( t)$ \\
\midrule 
...
\begin{itemize}
\item \textbf{linearità}, siano $f_{1}( t)\rightarrow F_{1}( s) ,f_{2}( t)\rightarrow F_{2}( s)$ e siano $\alpha ,\beta \in \mathbb{R}$\begin{equation*}
\alpha f_{1}( t) +\beta f_{2}( t) \ \ \xrightarrow{\mathcal{L}} \ \ \alpha F_{1}( s) +\beta F_{2}( s)
\end{equation*}
...
h( t) =\int\limits ^{t}_{0} f( \tau ) d\tau \ \ \xrightarrow{\mathcal{L}} \ \ H( s) =\frac{1}{s} F( s)
\end{equation*}
\item \textbf{traslazione}, sia $f( t)\rightarrow F( s)$\begin{equation}
h( t) =\begin{cases}
0, & 0\leqslant t< T\\
f( t-T) , & t >T
\end{cases} \ \ \xrightarrow{\mathcal{L}} \ \ H( s) =F( s) e^{-sT}
\end{equation}
\item \textbf{convoluzione}, siano $f( t)\rightarrow F( s) ,h( t)\rightarrow H( s)$\begin{equation*}
f( t) *h( t) =\int\limits ^{t}_{0} f( t-\tau ) h( \tau ) d\tau \ \ \xrightarrow{\mathcal{L}} \ \ F( s) H( s)
\end{equation*}
\end{itemize}
...
Abbiamo visto che la risposta all'impulso $u( t) =\mathrm{imp}( t)$ è $y( t) =ce^{At} b=g( t)$ che ha una sua trasformata di Laplace
\begin{equation*}
...
\begin{equation*}
\boxed{y_{\mathrm{imp}}( t) =\frac{d}{dt}[ y_{\mathrm{sca}}( t)]}
\end{equation*}
...
\begin{equation*}
y( t) =\int ^{t}_{0} g( t-\tau ) u( \tau ) d\tau \xrightarrow{\mathcal{L}}\boxed{Y( s) =G( s) U( s)}
\end{equation*}
...
\textit{Esempio.} Sia
\begin{equation*}
G( s) =\frac{2( s-1)}{( s+1)( s+2)^{2}} \ \ \ \ u( t) =\mathrm{sca}( t) \Rightarrow U( s) =\frac{1}{s}
\end{equation*}
...
\begin{equation*}
\boxed{f( 0) =\lim _{t\rightarrow 0^{+}} f( t) =\lim _{\mathrm{Re}( s)\rightarrow \infty }[ sF( s)]}
\end{equation*}
\end{theorem}
...
Sia $f( t)\xrightarrow{\mathcal{L}} F( s)$ allora
\begin{equation*}
\boxed{\lim _{t\rightarrow \infty } f( t) =\lim _{\mathrm{Re}( s)\rightarrow 0}[ sF( s)]}
\end{equation*}
\end{theorem}
...
%Straight Lines [id:da07977038312084872] 
\draw    (110,30) -- (478,30) ;
...
% Text Node
\draw (486,22.4) node [anchor=north west][inner sep=0.75pt]    {$\mathrm{Re}$};
% Text Node
\draw (71,62) node [anchor=north west][inner sep=0.75pt]   [align=left] {zeri inferiori};
% Text Node
\draw (372,62) node [anchor=north west][inner sep=0.75pt]   [align=left] {zeri superiori$=m_{s}$};
% Text Node
...
%Straight Lines [id:da3450406175949139] 
\draw    (110,30) -- (478,30) ;
\draw [shift={(480,30)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
\draw   (169.7,20.3) -- (190.3,40.91)(190.3,20.3) -- (169.7,40.91) ;
\draw   (349.7,20.3) -- (370.3,40.91)(370.3,20.3) -- (349.7,40.91) ;
...
%Straight Lines [id:da6280240311803158] 
...
%Straight Lines [id:da9154625332158219] 
...
%Straight Lines [id:da33890702748034984] 
...
Cosa succede quando la $G( s)$ ha poli complessi? Introduciamo una forma standard da usare quando ha due poli complessi. Con $\alpha _{1} ,\alpha _{2}  >0$ per la stabilità
\begin{equation*}
G( s) =\frac{\beta _{2}}{s^{2} +\alpha _{1} s+\alpha _{2}} =\mu \frac{\omega ^{2}_{n}}{s^{2} +2\xi \omega _{n} s+\omega ^{2}_{n}}
\end{equation*}
Con $\omega _{n}  >0$ \textbf{pulsazione naturale} e $\xi $ \textbf{smorzamento}.

La presenza di $\mu $ e $\omega ^{2}_{n}$ a numeratore permette di lasciare a $\mu $ il ruolo di guadagno:
\begin{equation*}
G( 0) =\mu \frac{\omega ^{2}_{n}}{\omega ^{2}_{n}} =\mu 
\end{equation*}
I poli valgono
\begin{equation*}
\begin{aligned}
p_{1,2} & =-\xi \omega _{n} \pm \sqrt{\xi ^{2} \omega ^{2}_{n} -\omega ^{2}_{n}}\\
 & =-\xi \omega _{n} \pm \omega _{n}\sqrt{\xi ^{2} -1}
\end{aligned}
\end{equation*}
L'ipotesi affinché siano \textit{complessi} e che ci sia \textit{stabilità} è $0< \xi < 1$
\begin{equation*}
p_{1,2} =-\xi \omega _{n} \pm i\omega _{n}\sqrt{1-\xi ^{2}} \ \ \Rightarrow \ \ T=-\frac{1}{\mathrm{Re}( p)} =\frac{1}{\xi \omega _{n}}
\end{equation*}
Qui $r=2$, allora
\begin{gather*}
y( 0) =0\\
\dot{y}( 0) =0\\
\ddot{y}( 0) =\mu \omega ^{2}_{n}  >0
\end{gather*}
Si hanno oscillazioni, la distanza tra gli estremi (che sono infiniti) rimane costante e vale
\begin{equation*}
\boxed{\tau =\frac{2\pi }{\mathrm{Im}( p)}}
\end{equation*}
...
%Straight Lines [id:da04695898277814581] 
\draw    (220,30) -- (278,30) ;
...
%Straight Lines [id:da8516105577055901] 
\draw    (100,30) -- (158,30) ;
...
%Straight Lines [id:da3975177870384137] 
\draw    (340,30) -- (398,30) ;
...
\begin{equation*}
u_{T}( t) =U\sin\left(\frac{2\pi }{T} t\right)
\end{equation*}
...
allora
\begin{equation*}
u_{T}( t) =U\sin( \omega t) =U\sin( 2\pi f\cdotp t)
\end{equation*}
...
\begin{equation*}
u( t) =U_{0} +\sum\limits ^{\infty }_{k=1} U_{k}\sin\left( k\frac{2\pi }{T} t+\varphi _{k}\right) ,\ \ k\in \mathbb{N}
\end{equation*}
Affinché ci sia convergeza della serie è necessario, ma non sufficiente, che $U_{k}\xrightarrow{k\rightarrow \infty } 0$.
\begin{theorem}
Sia $G( s) =\frac{N( s)}{\Delta ( s)}$, immaginiamo che sia compl. oss. e compl. ragg., quindi il modello esterno descrive completamente il sistema, altrimenti potremmo fare poco. Supponiamo che risponda all'ingresso $u_{T}( t) =U\sin( \omega t) ,\omega =2\pi /T$. Allora $\exists !$ uscita sinusoidale
\begin{equation*}
y_{T}( t) =Y\sin( \omega t+\varphi ) \ \ \Leftrightarrow \ \ \Delta ( i\omega ) \neq 0
\end{equation*}
In tal caso
\begin{equation*}
...
\begin{equation*}
\Delta ( s) y=N( s) u\ \ \Leftrightarrow \ \ y^{( n)}( t) +\cdots +\alpha _{n} y( t) =\beta _{0} u^{( n)}( t) +\cdots +\beta _{n} u( t)
\end{equation*}
e ognuna di queste equazioni differenziali, per ogni set di condizioni iniziali diverse, produrrà diverse uscite, che possiamo genericamente chiamare $y$, mentre una sola di queste sarà quella sinusoidale $y_{T}$. Scriviamole
\begin{gather*}
\Delta ( s) y_{T} =N( s) u_{T}\\
\Delta ( s) y=N( s) u_{T}
\end{gather*}
Sottraiamo
\begin{equation*}
...
\begin{equation*}
e( t)\rightarrow 0\ \forall e( 0) \ \ \Leftrightarrow \ \ y( t)\rightarrow y_{T}( t)
\end{equation*}
...
\begin{theorem}
Se $\Delta ( i\omega ) \neq 0$ e $u_{T}( t) =U\sin( \omega t)$ sappiamo che $y_{T}( t) =Y\sin( \omega t+\varphi )$. Allora
\begin{equation*}
\boxed{\frac{Y}{U} =| G( i\omega )| \ \ \ \ \varphi =\arg G( i\omega ) ,\ \varphi \in [ -\pi ,\pi )}
\end{equation*}
\end{theorem}
...
%Straight Lines [id:da7420104072982003] 
...
\begin{equation*}
\boxed{G( s) =\frac{\mu }{s^{h}} \cdot \frac{\prod _{j}( 1+s\tau _{j})}{\prod _{j}( 1+sT_{j})}}
\end{equation*}
I poli e zeri saranno della forma
\begin{equation*}
z_{j} =-\frac{1}{\tau _{j}} \ \ \ \ p_{j} =-\frac{1}{T_{j}}
\end{equation*}
...
%Straight Lines [id:da9932944332313498] 
...
%Straight Lines [id:da5430979557580746] 
\draw    (100,30) -- (397,30) (140,26) -- (140,34)(180,26) -- (180,34)(220,26) -- (220,34)(260,26) -- (260,34)(300,26) -- (300,34)(340,26) -- (340,34)(380,26) -- (380,34) ;
\draw [shift={(400,30)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (10.72,-5.15) -- (0,0) -- (10.72,5.15) -- (7.12,0) -- cycle    ;
...
Consideriamo
\begin{equation*}
| G( i\omega )| =\frac{| \mu | }{\omega ^{h}} \cdot \frac{\prod _{j}| 1+i\omega \tau _{j}| }{\prod _{j}| 1+i\omega T_{j}| }
\end{equation*}
Il logaritmo trasforma prodotti e divisioni in somme e sottrazioni
\begin{equation*}
\boxed{| G( i\omega )| _{\si{dB}} =20\log| \mu | -20h\log \omega +{\textstyle \sum\nolimits _{j} 20\log| 1+i\omega \tau _{j}| -\sum\nolimits _{j} 20\log| 1+i\omega T_{j}| }}
\end{equation*}
...
\draw   ;
%Straight Lines [id:da5264800359846014] 
...
\draw   ;
%Straight Lines [id:da941829613463353] 
...
%Straight Lines [id:da7325914373698694] 
...
%Straight Lines [id:da8277918836954627] 
...
%Straight Lines [id:da4479124040674598] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (201,117.75) -- (201,139.25) ;
%Straight Lines [id:da09872159024226113] 
...
Si ha
\begin{equation*}
\boxed{\arg G( i\omega ) =\arg \mu -h\arg( i\omega ) +{\textstyle \sum\nolimits _{j}\arg( 1+i\omega \tau _{j}) -\sum\nolimits _{j}}\arg( 1+i\omega T_{j})}
\end{equation*}
...
%Straight Lines [id:da29577293633604973] 
\draw [line width=1.5]    (160,50) -- (201,69.73) -- (239.5,69.73) -- (280,90) -- (340,150) ;
%Straight Lines [id:da32116377393774864] 
...
%Straight Lines [id:da13533478506246688] 
...
%Straight Lines [id:da752869940725337] 
...
%Straight Lines [id:da9317404980620012] 
...
%Straight Lines [id:da4163007627410782] 
...
%Straight Lines [id:da5287919361316695] 
...
%Straight Lines [id:da3139230622809084] 
...
% Text Node
\draw (380.5,108.58) node [anchor=north west][inner sep=0.75pt]    {$\frac{\omega }{\omega _{n}}$};
% Text Node
...
\begin{equation*}
\arg G( i\omega ) =-\arctan\left[\left( 2\xi \frac{\omega }{\omega _{n}}\right) /\left( 1-\left(\frac{\omega }{\omega _{n}}\right)^{2}\right)\right]
\end{equation*}
...
%Straight Lines [id:da30016081882640955] 
...
% Text Node
\draw (400.5,58.58) node [anchor=north west][inner sep=0.75pt]    {$\frac{\omega }{\omega _{n}}$};
% Text Node
...
\begin{figure}[htpb]
	...
	%Straight Lines [id:da7987471332507339] 
	\draw [line width=1.5]    (160,110) -- (201,89.73) -- (239.5,89.73) -- (280,130) -- (320,170) ;
	%Straight Lines [id:da3670725771728127] 
	\draw    (80.5,110.18) -- (354.5,110.18) (120.5,106.18) -- (120.5,114.18)(160.5,106.18) -- (160.5,114.18)(200.5,106.18) -- (200.5,114.18)(240.5,106.18) -- (240.5,114.18)(280.5,106.18) -- (280.5,114.18)(320.5,106.18) -- (320.5,114.18) ;
	\draw [shift={(356.5,110.18)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-4.9) .. controls (6.95,-2.3) and (3.31,-0.67) .. (0,0) .. controls (3.31,0.67) and (6.95,2.3) .. (10.93,4.9)   ;
	%Straight Lines [id:da6095757547584955] 
	\draw    (130.5,169.73) -- (130.5,33.73) (126.5,149.73) -- (134.5,149.73)(126.5,129.73) -- (134.5,129.73)(126.5,109.73) -- (134.5,109.73)(126.5,89.73) -- (134.5,89.73)(126.5,69.73) -- (134.5,69.73)(126.5,49.73) -- (134.5,49.73) ;
	\draw [shift={(130.5,31.73)}, rotate = 450] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-4.9) .. controls (6.95,-2.3) and (3.31,-0.67) .. (0,0) .. controls (3.31,0.67) and (6.95,2.3) .. (10.93,4.9)   ;
	%Straight Lines [id:da22835433273635064] 
	\draw  [dash pattern={on 0.84pt off 2.51pt}]  (130,90) -- (200,90) ;
	%Straight Lines [id:da8078716220528794] 
	\draw  [dash pattern={on 0.84pt off 2.51pt}]  (130,130) -- (280,130) ;
	%Straight Lines [id:da16364708990183074] 
	\draw    (80.5,230.18) -- (354.5,230.18) (120.5,226.18) -- (120.5,234.18)(160.5,226.18) -- (160.5,234.18)(200.5,226.18) -- (200.5,234.18)(240.5,226.18) -- (240.5,234.18)(280.5,226.18) -- (280.5,234.18)(320.5,226.18) -- (320.5,234.18) ;
	\draw [shift={(356.5,230.18)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-4.9) .. controls (6.95,-2.3) and (3.31,-0.67) .. (0,0) .. controls (3.31,0.67) and (6.95,2.3) .. (10.93,4.9)   ;
	%Straight Lines [id:da6176911330479431] 
	\draw    (130.5,329.73) -- (130.5,193.73) (126.5,309.73) -- (134.5,309.73)(126.5,289.73) -- (134.5,289.73)(126.5,269.73) -- (134.5,269.73)(126.5,249.73) -- (134.5,249.73)(126.5,229.73) -- (134.5,229.73)(126.5,209.73) -- (134.5,209.73) ;
	\draw [shift={(130.5,191.73)}, rotate = 450] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-4.9) .. controls (6.95,-2.3) and (3.31,-0.67) .. (0,0) .. controls (3.31,0.67) and (6.95,2.3) .. (10.93,4.9)   ;
	%Straight Lines [id:da5850795983040122] 
	\draw [line width=1.5]    (130.5,210.27) -- (200,210) -- (200,230) -- (240,230) -- (240,270) -- (320,270) ;
	%Straight Lines [id:da9254471161002336] 
	\draw  [dash pattern={on 0.84pt off 2.51pt}]  (130,250) -- (240,250) ;
	%Straight Lines [id:da7574529316144607] 
	...
	%Straight Lines [id:da7645543338803698] 
...
\begin{equation*}
G( s) =\frac{\mu }{s^{h}} \cdot \frac{\prod _{j}( 1+s\tau _{j})}{\prod _{j}( 1+sT_{j})} \cdot \frac{s^{2} +2\xi \omega _{n} s+\omega ^{2}_{n}}{\omega ^{2}_{n}}
\end{equation*}
...
%Straight Lines [id:da5279590564876968] 
\draw    (70,60) -- (107,60) ;
...
%Straight Lines [id:da7291117356502388] 
\draw    (130,60) -- (177,60) ;
...
%Straight Lines [id:da8358607048833555] 
\draw    (230,60) -- (277,60) ;
...
%Straight Lines [id:da7429658436596773] 
\draw    (330,60) -- (367,60) ;
...
%Straight Lines [id:da07450186395043845] 
\draw    (390,60) -- (457,60) ;
\draw [shift={(460,60)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (10.72,-5.15) -- (0,0) -- (10.72,5.15) -- (7.12,0) -- cycle    ;
%Straight Lines [id:da4893570878793809] 
...
%Straight Lines [id:da1198037046892877] 
\draw    (380,20) -- (380,47) ;
...
\begin{itemize}
\item $\mathrm{Re}( p_{i}) \leqslant 0\ \forall i$ (poli di $L( s)$)
\item $| L( i\omega )| $ attraversa $0\ \si{dB}$ una sola volta in $\omega =\omega _{c}$ (quindi per forza dall'alto verso il basso)
\end{itemize}

Allora $H( s)$ è asint. stabile se e solo se
\begin{itemize}
\item $\mu  >0$
\item $\varphi _{m}  >0$, dove $\varphi _{m}$ è il \textbf{margine di fase} e vale $\varphi _{m} =\pi -| \varphi _{c}| $, dove $\varphi _{c}$ è la \textbf{fase critica} e vale $\varphi _{c} =\arg L( i\omega _{c})$
\begin{itemize}
\item ovvero se $| \varphi _{c}| < \pi $
\end{itemize}
\end{itemize}
...
%Straight Lines [id:da8021966691821698] 
\draw    (160,40) -- (197,40) ;
\draw [shift={(200,40)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (10.72,-5.15) -- (0,0) -- (10.72,5.15) -- (7.12,0) -- cycle    ;
%Straight Lines [id:da866501708833618] 
\draw    (220,40) -- (257,40) ;
...
%Straight Lines [id:da06738899333796367] 
\draw    (310,40) -- (397,40) ;
\draw [shift={(400,40)}, rotate = 180] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (10.72,-5.15) -- (0,0) -- (10.72,5.15) -- (7.12,0) -- cycle    ;
%Straight Lines [id:da5798677927108005] 
...
%Straight Lines [id:da6546887912672721] 
\draw    (140,60) -- (388,60) ;
...
%Straight Lines [id:da5579876117720179] 
\draw    (160,110) -- (160,12) ;
...
%Straight Lines [id:da1872216662974786] 
\draw [line width=0.75]    (140,40) -- (230,40) -- (280,60) -- (330,100) ;
%Straight Lines [id:da4137751767753477] 
...
% Text Node
\draw (276,32.4) node [anchor=north west][inner sep=0.75pt]    {$\omega _{c}$};
% Text Node
...
È un filtro passa-basso, con banda $\{\omega :0< \omega < \omega _{c}\}$. Questo induce una stima del tempo di risposta. Indurre uno scalino alla $w$ significa chiedere quello specifico valore. Non conosciamo i poli di $H$, ma possiamo fare un esercizio di identificazione. Tipo $0$ e guadagno $0 \si{dB}$, cioè $1$.
\begin{equation*}
H( s) =\frac{1}{\left( 1+\frac{1}{\omega _{c}} s\right)^{2}}
\end{equation*}
L'esponente è $2$ perché nell'esempio considerato la pendenza finale è $-40$, in generale è diverso, ma la struttura è quella. Il primo cambio di pendenza è alla $\omega _{c}$ e la prima ci dice il tempo dominante.
\begin{equation*}
\boxed{T_{R} \simeq 5T_{D} =\frac{5}{\omega _{c}}}
\end{equation*}
...
%Straight Lines [id:da31805128754091716] 
\draw    (100,70) -- (137,70) ;
...
%Straight Lines [id:da443422004096764] 
\draw    (160,70) -- (207,70) ;
...
%Straight Lines [id:da974746542067676] 
\draw    (260,70) -- (297,70) ;
...
%Straight Lines [id:da1681793618483962] 
\draw    (320,70) -- (387,70) ;
...
%Straight Lines [id:da6472808677670767] 
...
%Straight Lines [id:da5929687141714681] 
\draw    (310,30) -- (310,57) ;
...
%Straight Lines [id:da3865800049623227] 
...
%Straight Lines [id:da3541956173155001] 
...
\begin{equation*}
e=\frac{1}{1+L} w-\frac{1}{1+L} d+\frac{L}{1+L} m=F_{1}( s) d_{1} +F_{2}( s) d_{2} +F_{3}( s) d_{3}
\end{equation*}
...
\end{equation*}
pertanto prima di $\omega _{c}$ si ha un ribaltamento nell'approssimazione della $F$.
...
%Straight Lines [id:da6088612539272849] 
\draw    (140,80) -- (428,80) ;
...
%Straight Lines [id:da16860741768363874] 
\draw    (160,150) -- (160,12) ;
\draw [shift={(160,10)}, rotate = 450] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-4.9) .. controls (6.95,-2.3) and (3.31,-0.67) .. (0,0) .. controls (3.31,0.67) and (6.95,2.3) .. (10.93,4.9)   ;
%Straight Lines [id:da06290181024362251] 
\draw [line width=0.75]    (140,40) -- (230,40) -- (330,80) -- (380,120) ;
%Straight Lines [id:da8971491896518446] 
...
\item {\fontfamily{pcr}\selectfont [Y,T,X] = lsim(SYS,U,T,X0)} restituisce {\fontfamily{pcr}\selectfont Y}, il vettore tempo {\fontfamily{pcr}\selectfont T} e i vettori di stato {\fontfamily{pcr}\selectfont X} (in una matrice dove la colonna $i$ è il vettore $x_{i}( t)$).
\end{itemize}
\end{itemize}
...
%Straight Lines [id:da9932548773837855] 
\draw    (200,30) -- (237,30) ;
...
%Straight Lines [id:da5363887687197131] 
\draw    (290,30) -- (377,30) ;
...
%Straight Lines [id:da8479434545097413] 
...
%Straight Lines [id:da9945240206614308] 
...
%Straight Lines [id:da3192675930825084] 
\draw    (120,30) -- (177,30) ;
...
% Text Node
\draw (253,16.4) node [anchor=north west][inner sep=0.75pt]    {$M_{1}$};
% Text Node
\draw (253,56.4) node [anchor=north west][inner sep=0.75pt]    {$M_{2}$};
% Text Node
...
% --- COSE FATTE ---
% figure centrate
% agginti {}{} dopo i theorem, ricalg, definition
% dB/dec sono diventati \si{dB/dec}
% section -> chapter
% subsection -> section
