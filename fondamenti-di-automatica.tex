...
\begin{definition}
	Si dice che $\overline{x} \in \mathbb{R}^n$ è un equilibrio se $x(0) =\overline{x} \Rightarrow x(t) =\overline{x} \ \forall t\geq 0$.
\end{definition}
...
\begin{enumerate}
	...
	\item $A$ è sempl. stabile $\Leftrightarrow $ $\Re\left(\lambda _i\right) \leq 0\ \forall i,\ \exists i:\Re\left(\lambda _i\right) =0$
...
\begin{itemize}
	\item \textbf{stabile} se $\forall \varepsilon  >0\ \exists \delta _{\varepsilon }  >0$ tale che\begin{equation*}
	      \Vert x(0) -\overline{x}\Vert < \delta _{\varepsilon } \Rightarrow \Vert x(t) -\overline{x}\Vert < \varepsilon \ \ \forall x(0) :\Vert x(0) -\overline{x}\Vert < \delta _{\varepsilon } ,\forall t\geq 0
	\end{equation*}
